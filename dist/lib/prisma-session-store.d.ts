...
export declare class PrismaSessionStore extends Store {
   ...
   * ```
   */
  constructor(prisma: IPrisma, options: IOptions);
  /**
  ...
  readonly all: (
    callback?:
      | ((err?: unknown, all?: ISessions | undefined) => void)
      | undefined
  ) => Promise<void | ISessions>;
  /**
  ...
  readonly get: (
    sid: string,
    callback?:
      | ((err?: unknown, val?: SessionData | undefined) => void)
      | undefined
  ) => Promise<void | SessionData>;
  /**
   ...
   */
  readonly ids: (
    callback?: ((err?: unknown, ids?: number[] | undefined) => void) | undefined
  ) => Promise<void | string[]>;
  /**
   ...
   */
  readonly length: (
    callback?: ((err: unknown, length: number) => void) | undefined
  ) => Promise<number | void>;
  /**
